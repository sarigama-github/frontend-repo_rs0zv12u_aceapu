      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-16 md:pt-28 md:pb-24">
        <div className="grid md:grid-cols-2 items-center gap-10">
          <div>
            ...
            >
              Data Analytics & Digital Marketing Powered by AI
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              Helping businesses grow with data-driven insights, automation, and smart marketing strategies.
            </motion.p>
            ...
            >
              <a href="#contact" className="px-6 py-3 rounded-xl bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600 text-white font-medium shadow-lg shadow-blue-500/30 hover:brightness-110 transition">
